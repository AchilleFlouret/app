import { arrayOf, bool, node, number, oneOf, oneOfType, string } from 'prop-types';
import { spacingPropType } from "../Box/propTypes";
import { ALIGN_ITEMS, ALIGN_SELF, DIRECTION, JUSTIFY_CONTENT } from "./constants";

var stringOrArrayOfStringsPropType = function stringOrArrayOfStringsPropType(constant) {
  var strings = Object.keys(constant);
