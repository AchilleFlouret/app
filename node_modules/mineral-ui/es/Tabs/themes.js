...
export var tabsTheme = function tabsTheme(baseTheme) {
  return _objectSpread({}, tabListTheme(baseTheme), tabPanelTheme(baseTheme), baseTheme);
};
export var tabTheme = function tabTheme(baseTheme) {
...
export var tabListTheme = function tabListTheme(baseTheme) {
  return _objectSpread({
...
export var tabPanelTheme = function tabPanelTheme(baseTheme) {
  return _objectSpread({
