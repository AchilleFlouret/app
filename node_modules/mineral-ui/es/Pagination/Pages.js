...
import { PagesRoot as Root, PagesEllipsisButton as EllipsisButton } from "./styled";
...
var getPageButtons = function getPageButtons(_ref) {
  ...
  return range(totalPages).map(function (_, index) {
    var page = index + 1;
    ...
    if (firstPageInRange || lastPageInRange) {
      pageView = ___EmotionJSX(EllipsisButton, {
        key: page
      }, "\u2026");
    } else if (!isPageOutOfRange || isFirstPage || isLastPage) {
      pageView = ___EmotionJSX(Button, _extends({}, isCurrentPage ? {
        'aria-current': true
...
var IncrementButton = forwardRef(function (_ref2, ref) {
  var _objectSpread2;
  ...
  return ___EmotionJSX(Button, buttonProps);
});
...
function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return ___EmotionJSX(Root, restProps, ___EmotionJSX(IncrementButton, _extends({
      direction: "previous",
      focusedNodeWhenDisabled: this.nextButton,
      ref: this.setPreviousButtonRef,
      size: size
    }, restProps)), showPageNumbers && getPageButtons(this.props), ___EmotionJSX(IncrementButton, _extends({
      direction: "next",
