...
export var getComparators = function getComparators(_ref2) {
...
export var getSelectableRows = function getSelectableRows(rows) {
  return rows.filter(function (row) {
    return !row.disabled;
  });
};
export var getSortable = function getSortable(_ref3) {
