...
export var primaryNavTheme = function primaryNavTheme(baseTheme) {
  return {
...
export var secondaryNavTheme = function secondaryNavTheme(baseTheme) {
  return {
...
export var navigationTheme = function navigationTheme(baseTheme) {
  return _objectSpread({}, primaryNavTheme(baseTheme), secondaryNavTheme(baseTheme), baseTheme);
};
export var primaryNavItemTheme = function primaryNavItemTheme(baseTheme) {
  return {
...
export var secondaryNavItemTheme = function secondaryNavItemTheme(baseTheme) {
  return {
    ...
    SecondaryNavItem_backgroundColor_pills_selected: baseTheme.backgroundColor_themePrimary,
    ...
    SecondaryNavItem_borderColor_pills_selected: baseTheme.backgroundColor_themePrimary,
...
export var navItemTheme = function navItemTheme(baseTheme) {
  return _objectSpread({}, primaryNavItemTheme(baseTheme), secondaryNavItemTheme(baseTheme), baseTheme);
};