import { arrayOf, bool, element, func, node, object, oneOf, oneOfType, shape, string } from 'prop-types';
import { LABEL_POSITION, SIZE } from "./constants";
export var checkboxPropTypes = {
  checked: bool,
  className: string,
  defaultChecked: bool,
...
export var checkboxGroupPropTypes = {
