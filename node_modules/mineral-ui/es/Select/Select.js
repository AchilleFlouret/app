...
function (_Component) {
  ...
  function Select() {
    ...
    _defineProperty(_assertThisInitialized(_this), "id", _this.props.id || "select-" + generateId());
    ...
    _defineProperty(_assertThisInitialized(_this), "getTriggerProps", function (props) {
      ...
      return _objectSpread({}, isRenderProp(trigger) ? props : {}, (_objectSpread2 = {
      ...
      }, _objectSpread2[refKey] = _this.setTriggerRef, _objectSpread2.variant = variant, _objectSpread2), !isRenderProp(trigger) ? props : {}, !readOnly ? {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTrigger", function (_temp) {
      ...
      return ___EmotionJSX(SelectTrigger, _this.getTriggerProps(props));
    });
  ...
  _proto.render = function render() {
    ...
    return ___EmotionJSX(ModifiersContext.Consumer, null, function (contextModifiers) {
      ...
      return ___EmotionJSX(Root, rootProps, isRenderProp(trigger) ? _this2.renderTrigger : _this2.renderTrigger());
    });
  };
...
Select.propTypes = process.env.NODE_ENV !== "production" ? selectPropTypes : {};