...
_styled('span', {
  ...
  var theme = buttonTheme(baseTheme);
  var rtl = theme.direction === 'rtl';
  var firstChildPaddingProperty = rtl ? 'paddingRight' : 'paddingLeft';
  var lastChildPaddingProperty = rtl ? 'paddingLeft' : 'paddingRight';
  var paddings;
  var fontSize = size === SIZE.small ? theme.ButtonContent_fontSize_small : theme.ButtonContent_fontSize;
  ...
  if (size === undefined || size === SIZE.large || size === SIZE.jumbo) {
    ...
    paddings = (_paddings = {}, _paddings['&:first-child' + ignoreSsrWarning] = (_ref3 = {}, _ref3[firstChildPaddingProperty] = padding, _ref3), _paddings['&:last-child'] = (_lastChild = {}, _lastChild[lastChildPaddingProperty] = padding, _lastChild), _paddings);
  }
...
_styled('button', {
  ...
  return _objectSpread({}, componentStyleReset(baseTheme), (_objectSpread2 = {
  ...
  }, _objectSpread2['& [role="img"]:first-child' + ignoreSsrWarning] = (_ref5 = {}, _ref5[firstChildMarginProperty] = theme.ButtonIcon_margin, _ref5), _objectSpread2['& [role="img"]:last-child'] = (_roleImgLast = {}, _roleImgLast[lastChildMarginProperty] = theme.ButtonIcon_margin, _roleImgLast), _objectSpread2['& [role="img"]:only-child'] = {
    margin: 0
  }, _objectSpread2));
});