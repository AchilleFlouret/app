...
export var menuDividerTheme = function menuDividerTheme(baseTheme) {
...
export var menuGroupTheme = function menuGroupTheme(baseTheme) {
  return _objectSpread({
...
export var menuItemTheme = function menuItemTheme(baseTheme) {
  return _objectSpread({
