					...
					return _react2.default.createElement(
						'li',
						{
							...
							onClick: function onClick() {
								return _this3.handleClick([item.start, item.end]);
							},
...
var _initialiseProps = function _initialiseProps() {
	...
	this.updateQuery = function (value, props) {
		...
		var query = RatingsFilter.defaultQuery(value, props);
	...
	this.handleClick = function (selectedItem) {
...
var ConnectedComponent = (0, _utils.connect)(mapStateToProps, mapDispatchtoProps)(function (props) {
	return _react2.default.createElement(RatingsFilter, _extends({ ref: props.myForwardedRef }, props));
});
