...
var ReactiveList = function (_Component) {
	...
	ReactiveList.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		...
		if (this.props.onData) {
			(0, _helper.checkSomePropChange)(this.props, prevProps, ['hits', 'streamHits', 'promotedResults'], function () {
	...
	ReactiveList.prototype.getData = function getData() {
		var _getAllData = this.getAllData(),
		    results = _getAllData.results,
	...
	ReactiveList.prototype.getComponent = function getComponent() {
	...
	ReactiveList.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			(0, _utils.hasCustomRenderer)(this.props) ? this.getComponent() : _react2.default.createElement(
				'div',
				{
				...
				filteredResults.map(function (item, index) {
					return renderItem(item, function () {
						_this3.triggerClickAnalytics(currentPage * size + index);
					});
				})
			),
			this.props.isLoading && this.showInfiniteScroll ? this.props.loader || _react2.default.createElement(
				'div',
				{
					style: {
						textAlign: 'center',
			...
			this.props.config.url.endsWith('appbase.io') && filteredResults.length ? _react2.default.createElement(
				_Flex2.default,
				{
	...
	_createClass(ReactiveList, [{
		...
		get: function get() {
			...
			var _getAllData3 = this.getAllData(),
			    filteredResults = _getAllData3.filteredResults;
		...
		get: function get() {
			...
			var _props4 = this.props,
			    ...
			    infiniteScroll = _props4.infiniteScroll;
...
ReactiveList.generateQueryOptions = function (props) {
	...
	if (props.sortOptions) {
		...
		options.sort = [(_ref10 = {}, _ref10[props.sortOptions[undefined.sortOptionIndex].dataField] = {
			order: props.sortOptions[undefined.sortOptionIndex].sortBy
		}, _ref10)];
...
var _initialiseProps = function _initialiseProps() {
	...
	this.loadMore = function () {
		if (_this4.props.hits && _this4.props.total !== _this4.props.hits.length) {
	...
	this.renderResultStats = function () {
		if (_this4.props.renderResultStats && _this4.props.total) {
			return _this4.props.renderResultStats(_this4.stats);
	...
	this.triggerClickAnalytics = function (searchPosition) {
		...
		var _props6 = _this4.props,
		    ...
		    searchId = _props6.analytics.searchId;
		var url = config.url,
		    app = config.app,
	...
	this.renderSortOptions = function () {
		return _react2.default.createElement(
			'select',
			{
				...
				defaultValue: _this4.sortOptionIndex
			},
	...
	this.withClickIds = function (results) {
		var _getAllData4 = _this4.getAllData(),
		    base = _getAllData4.base;
