...
var _initialiseProps = function _initialiseProps() {
	...
	this.updateDefaultQuery = function (queryOptions) {
		(0, _utils.updateInternalQuery)(_this3.internalComponent, queryOptions, Object.keys(_this3.state.currentValue), _this3.props, MultiDropdownList.generateQueryOptions(_this3.props, _this3.state.prevAfter));
	};
	...
	this.getComponent = function (items, downshiftProps) {
		...
		return (0, _utils2.getComponent)(data, _this3.props);
	};
};
