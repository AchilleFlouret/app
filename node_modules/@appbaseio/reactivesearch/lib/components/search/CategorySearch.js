...
var CategorySearch = function (_Component) {
	...
	function CategorySearch(props) {
		...
		var aggsQuery = _this.getAggsQuery(props.categoryField);
	...
	CategorySearch.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
		...
		(0, _helper.checkSomePropChange)(this.props, prevProps, ['fieldWeights', 'fuzziness', 'queryFormat', 'dataField', 'categoryField', 'nestedField'], function () {
...
var _initialiseProps = function _initialiseProps() {
	...
	this.onSuggestions = function (searchSuggestions) {
		var parseSuggestion = _this4.props.parseSuggestion;

		var fields = Array.isArray(_this4.props.dataField) ? _this4.props.dataField : [_this4.props.dataField];

		var parsedSuggestions = (0, _suggestions2.default)(fields, searchSuggestions, _this4.state.currentValue.toLowerCase());
		if (parseSuggestion) {
	...
	this.updateDefaultQuery = function (value, props) {
		...
		props.setQueryOptions(_this4.internalComponent, _extends({}, _this4.queryOptions, _this4.getAggsQuery(props.categoryField), defaultQueryOptions));
		props.updateQuery({
	...
	this.handleKeyDown = function (event, highlightedIndex) {
		...
		if (event.key === 'Enter' && highlightedIndex === null) {
			...
			_this4.onValueSelected(value, _causes2.default.ENTER_PRESS);
		}
	...
	this.renderIcons = function () {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				_InputIcon2.default,
				{ onClick: _this4.handleSearchIconClick, iconPosition: _this4.props.iconPosition },
				_this4.renderIcon()
			)
		);
	};
	...
	this.renderNoSuggestion = function () {
		...
		var _props5 = _this4.props,
		    themePreset = _props5.themePreset,
		    theme = _props5.theme,
		    isLoading = _props5.isLoading,
		    renderNoSuggestion = _props5.renderNoSuggestion,
		    innerClass = _props5.innerClass,
